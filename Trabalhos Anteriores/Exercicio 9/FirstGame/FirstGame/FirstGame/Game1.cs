...
namespace BookExample
{
    ...
    public class Game1 : Game
    {
        ...
        protected override void Draw(GameTime gameTime)
        {
            ...
            //FontSupportt.PrintStatus("Ball Position:" + mBall.mPosition, null);
            //FontSupportt.PrintStatusAt(mUWBLogo.mPosition,
            //mUWBLogo.mPosition.ToString(), Color.White);
            //FontSupportt.PrintStatusAt(mBall.mPosition, "Radius" + mBall.Radius, Color.Red);
            //mUWBLogo.Draw();
            //mBall.Draw();

            mTheGame.DrawGame();

            //// inform graphics system we are done drawing
            //FontSupportt.PrintStatus("Selected object is:" + mCurrentIndex +
            //" Location=" + mGraphicsObjects[mCurrentIndex].mPosition, null);
            //FontSupportt.PrintStatusAt(mGraphicsObjects[mCurrentIndex].mPosition, "Selected",
            //Color.Red);
