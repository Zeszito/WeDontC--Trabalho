...
{
    //Aqui esta uma struct para ter todos os inputs
    internal struct AllInputButtons
    {
        ...
        //a seguinte funcao retorna o botao pressionado independente do input device
    ...
    //Esta struct garante a prioridade do teclado sobre o joystick
    internal struct AllInputTrigger
    {
    ...
    /*A seguinte estrutura trata de mapear varios controlos de movimentos
    incluido joystic.*/
...
kRightThumbStickLeft, kRightThumbStickRight);
    ...
    static class InputWrapper
    {
        ...
        static public AllInputTrigger Triggers = new AllInputTrigger();
    }
}
